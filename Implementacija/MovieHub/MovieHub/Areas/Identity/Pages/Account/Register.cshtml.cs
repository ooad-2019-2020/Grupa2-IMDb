...
namespace MovieHub.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new RegistrovaniKorisnik { UserName = Input.Email, Email = Input.Email, AppUsername = Input.AppUsername, Ime = Input.Ime, Prezime = Input.Prezime, DatumRodjenja = Input.DatumRodjenja };
